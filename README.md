...
## Membros e Funções
* **Clarice Oliveira Minobolli Teixeira**: Desenvolvedor Fullstack
* **José Gabriel Silva**: Desenvolvedor Fullstack
* **Kauan Teixeira Pereira**: Desenvolvedor Fullstack
* **Lucas da Silva Santos**: Desenvolvedor Fullstack
